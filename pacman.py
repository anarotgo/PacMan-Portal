...
level = copy.deepcopy(maze)
color = 'blue'
PI = math.pi
player_images = []

for i in range(0, 5):
    player_images.append(pygame.transform.scale(pygame.image.load(f'assets/PacMan/Right/{i}.png'), (45, 45)))

blinky_img = pygame.transform.scale(pygame.image.load(f'assets/Ghosts/red/Down/Red_Ghost_Down0.png'), (50, 50))
pinky_img = pygame.transform.scale(pygame.image.load(f'assets/Ghosts/pink/Down/Pink_Ghost_Down0.png'), (50, 50))
inky_img = pygame.transform.scale(pygame.image.load(f'assets/Ghosts/blue/Down/Blue_Ghost_Down0.png'), (50, 50))
clyde_img = pygame.transform.scale(pygame.image.load(f'assets/Ghosts/orange/Down/Orange_Ghost_Down0.png'), (50, 50))
spooked_img = pygame.transform.scale(pygame.image.load(f'assets/Ghosts/Afraid/Ghost_Afraid0.png'), (50, 50))
dead_img = pygame.transform.scale(pygame.image.load(f'assets/Ghosts/Eyes/GhostEye_Down-1.png'), (50, 50))

# Player and Ghost locations and directions
player_x = 450
player_y = 663
direction = 0
blinky_x = 56
